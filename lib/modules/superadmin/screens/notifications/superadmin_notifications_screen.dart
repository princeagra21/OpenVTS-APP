...
class _SuperadminNotificationsScreenState
  ...
  @override
  void dispose() {
    _loadToken?.cancel('Superadmin notifications disposed');
    _markToken?.cancel('Superadmin notifications disposed');
    _markAllToken?.cancel('Superadmin notifications disposed');
    super.dispose();
  }
  ...
  Future<void> _loadNotifications() async {
    _loadToken?.cancel('Reload superadmin notifications');
  ...
  Future<void> _markOneRead(AdminNotificationItem item) async {
    ...
    _markToken?.cancel('Restart superadmin mark read');
    final token = CancelToken();
    _markToken = token;
  ...
  Future<void> _markAllRead() async {
    ...
    _markAllToken?.cancel('Restart superadmin mark all read');
    final token = CancelToken();
    _markAllToken = token;
