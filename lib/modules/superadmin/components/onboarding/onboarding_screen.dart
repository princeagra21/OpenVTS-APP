...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<Map<String, String>> _onboardingData = [
    ...
    },
    {
      ...
      'subtitle': 'Open VTS’s self-hosted GPS system gives logistics and trucking providers real-type updates, ensuring timely deliveries and compliance with traffic regulations. On-time reporting helps businesses streamline operations and keep clients satisfied.',
    },
  ];
