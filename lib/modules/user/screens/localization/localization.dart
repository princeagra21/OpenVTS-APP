...
class _LocalizationHeaderState extends State<LocalizationHeader> {
  ...
  UserLocalizationRepository? _repo;
  ...
  UserLocalizationRepository _repoOrCreate() {
    _repo ??= UserLocalizationRepository(api: _apiClientOrCreate());
    return _repo!;
  }
        ...
        children: [
          ...
          _buildSection(
            ...
            child: _loading
                ...
                : DropdownButtonFormField<String>(
                    initialValue: _selectedReferenceValue(
                      _languages,
                      selectedLanguage,
                    ),
          ...
          _buildSection(
            ...
            child: _loading
                ...
                : DropdownButtonFormField<String>(
                    initialValue: _selectedTimezoneValue(
                      _timezones,
                      selectedTimezoneOffset,
                    ),
                    decoration: _dropdownDecoration(context),
