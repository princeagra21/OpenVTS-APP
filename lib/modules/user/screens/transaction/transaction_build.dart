...
extension _TransactionScreenBuild on _TransactionScreenState {
  Widget _buildTransactionScreen(BuildContext context) {
    ...
    final rangeStart = _fromDate == null ? null : DateTime.tryParse(_fromDate!);
                            ...
                            children: [
                              Expanded(
                                child: InkWell(
                                  borderRadius: BorderRadius.circular(12),
                                  onTap: () =>
                                      _pickStatusFilter(context, cs, scale),
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(
                                      horizontal: 12,
                                      vertical: 10,
