...
import 'package:fleet_stack/modules/user/screens/account/accounts_screen.dart';
...
import 'package:fleet_stack/modules/user/screens/drivers/edit_driver_profile_screen.dart';
...
import 'package:fleet_stack/modules/user/screens/notification/push_notification_screen.dart';
...
import 'package:fleet_stack/modules/user/screens/sub_users/sub_user_details_screen.dart';
...
import 'package:fleet_stack/modules/user/screens/setting/setting_screen.dart';
...
final List<GoRoute> userRoutes = [
  ...
  GoRoute(path: '/user/dashboard', builder: (_, __) => const DashboardScreen()),
  GoRoute(path: '/user/maps', builder: (_, __) => const MapScreen()),
  GoRoute(path: '/user/admin', builder: (_, __) => const AdminScreen()),
  GoRoute(path: '/user/accounts', builder: (_, __) => const AccountsScreen()),
  GoRoute(
  ...
  GoRoute(
    path: '/user/sub-users/details/:id',
