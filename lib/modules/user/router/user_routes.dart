...
final List<GoRoute> userRoutes = [
  ...
  GoRoute(path: '/user/share-track', builder: (_, __) => const ShareTrackScreen()),
  GoRoute(path: '/user/share-track/add', builder: (_, __) => const ShareTrackAddScreen()),
  GoRoute(path: '/user/vehicles', builder: (_, __) => const VehicleScreen()),
  GoRoute(path: '/user/vehicles/add', builder: (_, __) => const AddVehicleScreen()), 
  GoRoute(path: '/user/drivers', builder: (_, __) => const DriverScreen()),
  GoRoute(path: '/user/drivers/add', builder: (_, __) => const AddDriverScreen()),
  GoRoute(path: '/user/geofence', builder: (_, __) => const GeofenceScreen()),
  GoRoute(path: '/user/route-optimization', builder: (_, __) => const RouteOptimizationScreen()),
  GoRoute(path: '/user/support', builder: (_, __) => const SupportScreen()),
  GoRoute(path: '/user/profile', builder: (_, __) => const ProfileScreen()),
  GoRoute(path: '/user/generate-report', builder: (_, __) => const GenerateReportScreen()),
  GoRoute(path: '/user/localization', builder: (_, __) => const LocalizationSettingsScreen()),
  GoRoute(path: '/user/notifications', builder: (_, __) => const NotificationsScreen()),
  GoRoute(path: '/user/sub-users', builder: (_, __) => const SubUserScreen()),
  GoRoute(
    path: '/user/toggle/:vehicleId',
    builder: (context, state) => VehicleToggleScreen(
      vehicleId: state.pathParameters['vehicleId']!,
    ),
  ),
  GoRoute(path: '/user/more', builder: (_, __) => const MoreScreen()),
  GoRoute(path: '/user/transactions', builder: (_,  __) => const TransactionScreen()),
  GoRoute(
