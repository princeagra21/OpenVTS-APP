...
final List<GoRoute> adminRoutes = [
  ...
  GoRoute(path: '/admin/vehicles/add', builder: (_, __) => const AddVehicleScreen()),
  GoRoute(path: '/admin/drivers', builder: (_, __) => const DriverScreen()),
  GoRoute(path: '/admin/drivers/add', builder: (_, __) => const AddDriverScreen()),
  ...
  GoRoute(path: '/admin/devices/add', builder: (_, __) => const AddDeviceScreen()),
  ...
  GoRoute(path: '/admin/payments/add', builder: (_, __) => const AddPaymentScreen()),
  GoRoute(path: '/admin/transactions', builder: (_, __) => const TransactionScreen()),
  GoRoute(path: '/admin/calendar', builder: (_, __) => const EventCalendarScreen()),
  ...
  GoRoute(path: '/admin/white-label', builder: (_, __) => const BrandingSettingsScreen()), 
  GoRoute(path: '/admin/profile', builder: (_, __) => const ProfileScreen()),
  GoRoute(path: '/admin/branding', builder: (_, __) => const BrandingScreen()), 
  GoRoute(path: '/admin/smtp-settings', builder: (_, __) => const SmtpConfigSettingsScreen()),
  GoRoute(path: '/admin/localization', builder: (_, __) => const LocalizationSettingsScreen()),
  GoRoute(path: '/admin/finance-dashboard', builder: (_, __) => const AnalyticsScreen()),
  GoRoute(path: '/admin/application-settings', builder: (_, __) => const ApplicationSettingsScreen()),
  GoRoute(path: '/admin/notify-user', builder: (_, __) => const NotifyUsersScreen()),
  GoRoute(path: '/admin/notification-preferences', builder: (_, __) => const NotificationPreferencesScreen()),
  ...
  GoRoute(path: '/admin/renewals/add', builder: (_, __) => const AddRenewalScreen()),
  GoRoute(path: '/admin/support', builder: (_, __) => const SupportScreen()),
  GoRoute(
    path: '/admin/renewals/renew',
    builder: (context, state) {
      final selectedDevices = (state.extra as List<Map<String, dynamic>>?) 
  ...
  GoRoute(
    ...
    builder: (context, state) {
      ...
      final type = extra['type'] as String? ?? 'Vehicles'; // Default to 'Vehicles' if not provided
