...
class AdminUserDocumentsTab extends StatefulWidget {
  ...
  @override
  State<AdminUserDocumentsTab> createState() => _AdminUserDocumentsTabState();
}

class _AdminUserDocumentsTabState extends State<AdminUserDocumentsTab> {
  ...
  @override
  void dispose() {
    _token?.cancel('AdminUserDocumentsTab disposed');
  ...
  Future<void> _loadDocs() async {
    _token?.cancel('Reload user documents');
