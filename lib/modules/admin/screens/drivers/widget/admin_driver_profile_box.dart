...
class AdminDriverProfileBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final roleLabel = 'Driver';
    final statusLabel = safeText(details?.statusLabel);
    final verified = details?.isVerified == true;
    final primaryUser = safeText(details?.primaryUserName);
          ...
          Wrap(
            ...
            children: [
              _chip(
                context,
                label: statusLabel,
                bg: statusLabel.toLowerCase().contains('active')
                    ? Colors.green.withValues(alpha: 0.2)
                    : colorScheme.error.withValues(alpha: 0.16),
                fg: statusLabel.toLowerCase().contains('active')
