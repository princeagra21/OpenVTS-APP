  ...
  static List<SslCertificateItem> fromResponse(Object? data) {
    ...
    for (final item in list) {
      if (item is Map<String, Object?>) {
        ...
        out.add(SslCertificateItem(Map<String, Object?>.from(item.cast())));
      }
    }
    return out;
  }
    ...
    if (data is Map<String, Object?>) {
      ...
      for (final c in candidates) {
        ...
        if (c is Map<String, Object?>) {
          ...
          final nested = _extractList(Map<String, Object?>.from(c.cast()));
          if (nested != null) return nested;
        }
      }
    }
    if (data is Map) {
      return _extractList(Map<String, Object?>.from(data.cast()));
    }
    return null;
  }
