...
class ApiConfigHeader extends StatefulWidget {
  const ApiConfigHeader({super.key, required this.state, required this.controller});

  final ApiConfigState state;
...
class _ApiConfigHeaderState extends State<ApiConfigHeader> {
  ...
  @override
  void didUpdateWidget(covariant ApiConfigHeader oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (oldWidget.state.config == widget.state.config) return;
    final config = widget.state.config;
  ...
  void _updateConfig({
    ...
    final current = widget.state.config;
          ...
          children: [
            ...
            _buildDropdown(
              ...
              onChanged: (value) {
                ...
                updateLocalUiState(this, () => selectedProvider = value);
                _updateConfig();
              },
            ),
            _buildSwitchField(
        ...
        _buildSection(
          ...
          children: [
            ...
            _buildDropdown(
              ...
              onChanged: (value) {
                if (value == null) return;
                updateLocalUiState(this, () => selectedModel = value);
                _updateConfig();
              },
            ),
      ...
      children: [
        ...
        Slider(
          ...
          onChanged: (value) {
            ...
            updateLocalUiState(this, () => maxTokens = next);
