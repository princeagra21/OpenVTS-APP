...
class _BrandingScreenState extends State<BrandingScreen> {
 ...
 Color get currentBrand => themeController.brandColor.value;
            ...
            Wrap(
              ...
              children: themeColors.keys.map((themeName) {
                ...
                return GestureDetector(
                  onTap: () async {
                    updateLocalUiState(this, () => selectedTheme = themeName);
  ...
  updateLocalUiState(this, () => isDarkMode = newDark);

  // If Default theme is selected, force the correct brand color
  if (selectedTheme == "Default") {
    final forcedBrand =
        newDark ? OpenVtsTheme.defaultDarkBrand : OpenVtsTheme.defaultBrand;
