...
import 'package:open_vts/features/reference_data/di/reference_data_providers.dart' show ReferenceOption, TimezoneOption;
...
class _AdminSettingsTabState extends ConsumerState<AdminSettingsTab> {
  ...
  Future<void> _loadAll() async {
    ...
    try {
      ...
      final referenceOptions = ref.read(superadminReferenceOptionsGatewayUseCaseProvider);
      final languagesRes = await referenceOptions.getLanguages();
      if (languagesRes.isSuccess && languagesRes.valueOrNull!.isNotEmpty) {
        _languageOptions = languagesRes.valueOrNull!;
      }

      final dateFormatsRes = await referenceOptions.getDateFormats();
      if (dateFormatsRes.isSuccess && dateFormatsRes.valueOrNull!.isNotEmpty) {
        _dateFormatOptions = dateFormatsRes.valueOrNull!;
      }

      final timezonesRes = await referenceOptions.getTimezones();
      if (timezonesRes.isSuccess && timezonesRes.valueOrNull!.isNotEmpty) {
        _timezoneOptions = timezonesRes.valueOrNull!;
      }

      // Admin settings (protected).
      final adminSettingsRes = await ref.read(getSuperadminAdminGatewayUseCaseProvider).getAdminSettings(
        widget.adminId,
      );

      if (adminSettingsRes.isSuccess) {
        _applyServerSettings(adminSettingsRes.valueOrNull!);
      ...
      if (mounted) updateLocalUiState(this, () => _loading = false);
    }
  }
  ...
  Future<void> _resetToServer() async {
    ...
    try {
      ...
      if (adminSettingsRes.isSuccess) {
        _applyServerSettings(adminSettingsRes.valueOrNull!, clearIfEmpty: true);
  ...
  Future<void> _saveSettings() async {
    ...
    try {
      final res = await ref.read(getSuperadminAdminGatewayUseCaseProvider).updateAdminSettings(
        widget.adminId,
        AdminSettings(Map<String, Object?>.from(payload)),
      );

      if (res.isSuccess) {
        _applyServerSettings(res.valueOrNull!);
        await _persistLocalSettings();
      ...
      if (mounted) updateLocalUiState(this, () => _saving = false);
    }
  }
  ...
  Widget _buildThemeOption({
    ...
    return Expanded(
      child: InkWell(
        onTap: () {
          updateLocalUiState(this, () => _selectedTheme = value);
        },
        child: Column(
          children: [
            if (textOnTop)
            ...
            Radio<String>(
              ...
              onChanged: (v) {
                updateLocalUiState(this, () => _selectedTheme = v);
              },
            ),
            if (!textOnTop)
              Text(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildLanguagePicker(
                          ...
                          showLabel: false,
                          onSelected: (v) {
                            updateLocalUiState(this, () => _selectedLanguage = v);
                          },
                        ),
                      ],
                    ),
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    updateLocalUiState(this, () => _selectedDirection = 'LTR');
                                  },
                                  borderRadius: BorderRadius.circular(10),
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    updateLocalUiState(this, () => _selectedDirection = 'RTL');
                                  },
                                  borderRadius: BorderRadius.circular(10),
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildLanguagePicker(
                          ...
                          showLabel: false,
                          onSelected: (v) {
                            updateLocalUiState(this, () => _selectedDateFormat = v);
                          },
                        ),
                      ],
                    ),
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    updateLocalUiState(this, () => _selectedTheme = 'light');
                                  },
                                  borderRadius: BorderRadius.circular(10),
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    updateLocalUiState(this, () => _selectedTheme = 'dark');
                                  },
                                  borderRadius: BorderRadius.circular(10),
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    updateLocalUiState(this, () => _selectedTheme = 'system');
                                  },
                                  borderRadius: BorderRadius.circular(10),
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(
                      ...
                      children: [
                        ...
                        _buildLanguagePicker(
                          ...
                          options: _timezoneOptions
                              ...
                              .toList(),
                          onSelected: (v) {
                            updateLocalUiState(this, () => _selectedTimezone = v);
                          },
                        ),
                      ],
                    ),
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    updateLocalUiState(this, () => _selectedUnit = 'KM');
                                  },
                                  borderRadius: BorderRadius.circular(10),
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    updateLocalUiState(this, () => _selectedUnit = 'MILES');
                                  },
                                  borderRadius: BorderRadius.circular(10),
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(
