...
class SuperadminSettingsTab extends ConsumerStatefulWidget {
  const SuperadminSettingsTab({super.key});

  @override
  ConsumerState<SuperadminSettingsTab> createState() => _SuperadminSettingsTabState();
}

class _SuperadminSettingsTabState extends ConsumerState<SuperadminSettingsTab> {
  ...
  Future<void> _loadPreferences() async {
    ...
    try {
      final res = await ref.read(superadminPreferencesGatewayUseCaseProvider).getAppPreferences();
      if (!mounted) return;
      ...
      res.when(
        ...
        failure: (err) {
          ...
          final msg = "Couldn't load settings.";
  ...
  Future<void> _savePreferences() async {
    ...
    try {
      ...
      final res = await ref.read(superadminPreferencesGatewayUseCaseProvider).updateAppPreferences(payload);
      ...
      res.when(
        ...
        failure: (err) {
          ...
          final msg = "Couldn't save settings.";
          ScaffoldMessenger.of(context)
              .showSnackBar(SnackBar(content: Text(msg)));
        },
      );
                  ...
                  OutlinedButton.icon(
                    onPressed: (_saving || _loading)
                        ...
                        : () {
                            ...
                            updateLocalUiState(this, () => _applySnapshot(snapshot));
                          },
            ...
            child: Column(
              ...
              children: [
                ...
                _numberField(
                  ...
                  value: signupCredits,
                  onChanged: (v) => updateLocalUiState(this, () => signupCredits = v),
                  labelFs: labelFs,
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Switch(
                    value: demoEnabled,
                    onChanged: (v) => updateLocalUiState(this, () => demoEnabled = v),
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (v) =>
                      updateLocalUiState(this, () => backupRetention = v ?? backupRetention),
                  style: AppFonts.roboto(
                    fontSize: valueFs,
                    fontWeight: FontWeight.w600,
                    color: colorScheme.onSurface,
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Switch(
                          value: signupAllowed,
                          onChanged: (v) => updateLocalUiState(this, () => signupAllowed = v),
                          activeThumbColor: colorScheme.primary,
                        ),
                      ],
                    ),
