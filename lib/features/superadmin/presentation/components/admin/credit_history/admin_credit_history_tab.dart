...
class AdminCreditHistoryTab extends ConsumerStatefulWidget {
  final String adminId;

  const AdminCreditHistoryTab({super.key, required this.adminId});

  @override
  ConsumerState<AdminCreditHistoryTab> createState() => _AdminCreditHistoryTabState();
}

class _AdminCreditHistoryTabState extends ConsumerState<AdminCreditHistoryTab> {
  DateTime? _startDate;
  DateTime? _endDate;
  bool _loading = false;
