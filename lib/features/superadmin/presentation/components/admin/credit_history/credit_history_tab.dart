...
import 'package:open_vts/features/superadmin/presentation/components/admin/credit_history/add_deduct_credit_screen.dart';
import 'package:open_vts/features/superadmin/presentation/components/admin/credit_history/credit_history_details_screen.dart';
import 'package:open_vts/features/superadmin/presentation/components/admin/credit_history/email_screen.dart';
...
class CreditHistoryTab extends ConsumerStatefulWidget {
  final String adminId;

  const CreditHistoryTab({super.key, required this.adminId});

  @override
  ConsumerState<CreditHistoryTab> createState() => _CreditHistoryTabState();
}

class _CreditHistoryTabState extends ConsumerState<CreditHistoryTab> {
  DateTime? _startDate;
  DateTime? _endDate;
              ...
              GestureDetector(
                onTap: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text(
                        'Download export is available from the admin credit history report.',
                      ),
                    ),
                  );
                },
