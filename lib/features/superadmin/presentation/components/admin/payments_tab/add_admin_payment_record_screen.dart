...
class AddAdminPaymentRecordScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AddAdminPaymentRecordScreen> createState() =>
      _AddAdminPaymentRecordScreenState();
}

class _AddAdminPaymentRecordScreenState
    extends ConsumerState<AddAdminPaymentRecordScreen> {
  ...
  Future<void> _submit() async {
    ...
    _submitToken = AppCancellationHandle();
