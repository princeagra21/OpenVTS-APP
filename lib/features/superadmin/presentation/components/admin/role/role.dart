...
class _RolesScreenState extends ConsumerState<RolesScreen> {
  ...
  List<SuperadminRole> _roles = const <SuperadminRole>[];
  ...
  late final _repo = ref.read(superadminSettingsRepositoryProvider);
    ...
    try {
      ...
      res.when(
        ...
        failure: (err) {
          ...
          final message = "Couldn't load roles.";
  ...
  List<Map<String, Object?>> _normalizeRoles(List<Map<String, Object?>> rows) {
  ...
  Map<String, Object?> _normalizeRole(Map<String, Object?> raw) {
  ...
  int _pickInt(Map<String, Object?> source, List<String> keys) {
    for (final key in keys) {
      final value = source[key];
      if (value == null) continue;
  ...
  void _applyRoleFromMap(SuperadminRole role) {
    final roleKey = role.key.trim();
    final title = role.title.trim();
    final currency = role.currency.trim().toUpperCase();
    final amount = role.amount;
    final rolePermissions = Map<String, int>.from(role.permissions);
                ...
                children: [
                  ...
                  if (showSkeleton)
                    ...
                    TextField(
                      ...
                      onChanged: (v) => updateLocalUiState(this, () => selectedRoleTitle = v),
                      decoration: _inputDecoration(context, hint: "Role name"),
                      style: AppFonts.roboto(color: scheme.onSurface),
                    ),
                        ...
                        Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton<String>(
                              ...
                              onChanged: (v) {
                                if (v == null) return;
                                updateLocalUiState(this, () => selectedCurrency = v);
                              },
                              items: currencies
                                  .map(
                                    (c) => DropdownMenuItem(
                        ...
                        Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton<int>(
                              ...
                              onChanged: (v) {
                                if (v == null) return;
                                updateLocalUiState(this, () => selectedAmount = v);
                              },
                              items: amounts
                                  .map(
                                    (a) => DropdownMenuItem(
