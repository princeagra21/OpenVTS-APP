...
class ApplicationHeader extends ConsumerStatefulWidget {
  const ApplicationHeader({super.key});

  @override
  ConsumerState<ApplicationHeader> createState() => _ApplicationHeaderState();
}

class _ApplicationHeaderState extends ConsumerState<ApplicationHeader> {
  ...
  late final _repo = ref.read(appPreferencesRepositoryAdapterProvider);
  ...
  Future<void> _loadPreferences() async {
    ...
    try {
      final res = await _repo.getAppPreferences(cancelToken: token);
      if (!mounted) return;
  ...
  Future<bool> _savePreferences({bool showSuccess = true}) async {
    ...
    try {
      final res = await _repo.updateAppPreferences(
        payload,
        cancelToken: token,
      );
      if (!mounted) return false;
      ...
      child: Column(
        ...
        children: [
          ...
          _buildToggleSection(
            ...
            onChanged: _saving
                ? (_) {}
                : (v) => updateLocalUiState(this, () => demoEnabled = v),
          ),
            ...
            child: Row(
              children: [
                ChoiceChip(
                  ...
                  onSelected: (_) {
                    if (_saving) return;
                    updateLocalUiState(this, () => geocodingPrecision = "2 Digits");
                  },
                ),
                const SizedBox(width: 12),
                ChoiceChip(
                  ...
                  onSelected: (_) {
                    if (_saving) return;
                    updateLocalUiState(this, () => geocodingPrecision = "3 Digits");
                  },
                ),
              ],
            ),
            ...
            child: Column(
              ...
              children: [
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (v) {
                    if (_saving) return;
                    if (v != null) updateLocalUiState(this, () => backupRetention = v);
                  },
                ),
                  ...
                  children: [
                    ...
                    Transform.scale(
                      ...
                      child: Switch(
                        ...
                        onChanged: _saving
                            ? null
                            : (v) => updateLocalUiState(this, () => signupAllowed = v),
                      ),
                    ),
                  ],
                ),
