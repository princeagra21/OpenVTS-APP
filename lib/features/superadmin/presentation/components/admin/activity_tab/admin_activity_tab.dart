...
class _AdminActivityTabState extends ConsumerState<AdminActivityTab> {
  final AppCancellationHandle _token = AppCancellationHandle();
  bool _loading = false;
                                  ...
                                  builder: (context, setDialogState) {
                                    return CalendarDatePicker2(
                                      ...
                                      onValueChanged: (values) {
                                        ...
                                        if (values.length >= 2) {
                                          final pickedStart = values.first;
                                          final pickedEnd = values.last;
                                          final normalizedStart = _startOfDay(
                                            pickedStart,
                                          );
                                          final normalizedEnd = _endOfDay(
                                            pickedEnd,
                                          );
