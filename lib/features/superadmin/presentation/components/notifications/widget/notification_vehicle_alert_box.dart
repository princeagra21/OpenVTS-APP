    ...
    return Column(
      ...
      children: [
        ...
        NotificationToggleTile(
          ...
          value: offline,
          onChanged: (v) => updateLocalUiState(this, () => offline = v),
        ),
        SizedBox(height: spacing),
        NotificationToggleTile(
          icon: Icons.speed,
          ...
          value: overspeed,
          onChanged: (v) => updateLocalUiState(this, () => overspeed = v),
        ),
        SizedBox(height: spacing),
        NotificationToggleTile(
          icon: Icons.power,
          ...
          value: ignition,
          onChanged: (v) => updateLocalUiState(this, () => ignition = v),
        ),
        SizedBox(height: spacing),
        NotificationToggleTile(
        ...
        NotificationToggleTile(
          ...
          value: sos,
          onChanged: (v) => updateLocalUiState(this, () => sos = v),
        ),
      ],
    );
  }
