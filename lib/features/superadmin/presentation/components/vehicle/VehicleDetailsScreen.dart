...
import 'package:open_vts/features/superadmin/presentation/components/vehicle/widget/send_command.dart';
import 'package:open_vts/features/superadmin/presentation/components/vehicle/widget/vehicle_config_tab.dart';
import 'package:open_vts/features/superadmin/presentation/components/vehicle/widget/vehicle_details_tab.dart';
import 'package:open_vts/features/vehicles/presentation/widgets/vehicle_documents_tab.dart';
import 'package:open_vts/features/superadmin/presentation/components/vehicle/widget/vehicle_logs_tab.dart';
import 'package:open_vts/features/superadmin/presentation/components/vehicle/widget/vehicle_map_tab.dart';
import 'package:open_vts/features/superadmin/presentation/components/vehicle/widget/vehicle_users_tab.dart';
...
class _VehicleDetailsScreenState extends ConsumerState<VehicleDetailsScreen> {
  ...
  Future<void> _loadDetails() async {
    ...
    if (!mounted) return;
    updateLocalUiState(this, () => _loadingDetails = true);

    try {
      _repo ??= ref.read(superadminVehicleRepositoryProvider);

      final res = await _repo!.getVehicleDetail(widget.id);
      if (!mounted) return;
      ...
      res.when(
          ...
          updateLocalUiState(this, () {
            _details = VehicleDetails({
              'data': {
                ...
                'telemetry': {'updatedAt': d.telemetryUpdatedAt},
              },
            });
        ...
        failure: (err) {
          if (!mounted) return;
          updateLocalUiState(this, () => _loadingDetails = false);
          if (_errorShown) return;
          _errorShown = true;
          final msg = "Couldn't load vehicle.";
          ...
          : Column(
              ...
              children: [
                ...
                NavigateBox(
                  ...
                  tabs: tabs,
                  onTabSelected: (tab) => updateLocalUiState(this, () => selectedTab = tab),
                ),
