...
class GetSuperadminSettingsUseCase {
  const GetSuperadminSettingsUseCase(this._repository);
  final SuperadminSettingsRepository _repository;
  Future<Result<SuperadminSettingsData, AppError>> call(String adminId) => _repository.getSettings(adminId);
}
