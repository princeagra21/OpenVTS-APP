...
class _SuperadminSettingsApiService implements SuperadminSettingsApiService {
  _SuperadminSettingsApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ApiResponse<Map<String, dynamic>>> updateSettings(
    String adminId,
    SuperadminSettingsMutationDto body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<void>> updateRole(
    String roleId,
    SuperadminRoleMutationDto body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
