...
import 'package:open_vts/features/map/presentation/controllers/map_vehicle_details_controller.dart';
...
class VehicleDetailsBottomSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final provider = mapVehicleDetailsControllerProvider(vehicle);
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  if (state.loadingDetails) _LoadingState(vehicle: vehicle),
                  if (!state.loadingDetails && state.error != null)
                    _ErrorState(
                      title: state.error!,
                  ...
                  if (!state.loadingDetails &&
                    ...
                    _CompactVehicleCard(
                      ...
                      resolvingAddress: state.resolvingAddress,
                    ),
                ],
              ),
            ),
