    ...
    return Column(
      ...
      children: [
        ...
        NotificationToggleTile(
          ...
          value: offline,
          onChanged: (v) {
            updateLocalUiState(this, () => offline = v);
        ...
        NotificationToggleTile(
          ...
          value: overspeed,
          onChanged: (v) {
            updateLocalUiState(this, () => overspeed = v);
            widget.onAttemptPersist?.call();
          },
        ),
        SizedBox(height: spacing),
        NotificationToggleTile(
          ...
          value: ignition,
          onChanged: (v) {
            updateLocalUiState(this, () => ignition = v);
            widget.onAttemptPersist?.call();
          },
        ),
        SizedBox(height: spacing),
        NotificationToggleTile(
          ...
          value: geofence,
          onChanged: (v) {
            updateLocalUiState(this, () => geofence = v);
            widget.onAttemptPersist?.call();
          },
        ),
        SizedBox(height: spacing),
