...
import 'package:open_vts/features/admin/presentation/screens/logs/log_details_screen.dart';
...
class _LogsScreenState extends ConsumerState<LogsScreen> {
  ...
  Future<void> _loadLogs() async {
    ...
    final ok = await ref.read(adminLogsControllerProvider.notifier).load(limit: 100);
    if (!mounted) return;
    final nextState = ref.read(adminLogsControllerProvider);
    ...
    if (!ok && !_errorShown) {
      _errorShown = true;
      final message = nextState.error?.message.trim().isNotEmpty == true
  ...
  Future<void> _pickDateRange() async {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        TextButton(
                          onPressed: () {
                            updateLocalUiState(this, () => _dateRange = null);
                            Navigator.pop(ctx);
                          },
    ...
    updateLocalUiState(this, () => _dateRange = picked);
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        onChanged: (v) => updateLocalUiState(this, () => _query = v),
