                              ...
                              Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton<String>(
                                    ...
                                    isExpanded: true,
                                    style: AppFonts.inter(color: scheme.onSurface),
                                    onChanged: (v) => updateLocalUiState(this, () => selectedCurrency = v!),
                                    items: currencies
                              ...
                              Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton<int>(
                                    ...
                                    isExpanded: true,
                                    style: AppFonts.inter(color: scheme.onSurface),
                                    onChanged: (v) => updateLocalUiState(this, () => selectedAmount = v!),
                                    items: amounts
                                  ...
                                  child: Wrap(
                                    ...
                                    children: [
                                      ...
                                      return _LocalTab(
                                        label: label,
                                        selected: isSelected,
                                        onTap: () => updateLocalUiState(this, () => permissions[module] = level),
                                      );
                                    }).toList(),
                                  ),
                                ),
