                      ...
                      child: Column(
                        children: [
                          RadioListTile<String>(
                            ...
                            onChanged: (v) => updateLocalUiState(this, () => notificationMode = v!),
                          ),
                          RadioListTile<String>(
    ...
    child: Row(
      ...
      children: [
        _channelItem(
          ...
          onChanged: (v) => updateLocalUiState(this, () => channelSelections[0] = v!),
          cs: cs,
          fs: fs,
        ),
        _channelItem(
          ...
          onChanged: (v) => updateLocalUiState(this, () => channelSelections[1] = v!),
          cs: cs,
          fs: fs,
        ),
        _channelItem(
          ...
          onChanged: (v) => updateLocalUiState(this, () => channelSelections[2] = v!),
          cs: cs,
          fs: fs,
        ),
      ],
