...
class _DeviceScreenState extends ConsumerState<DeviceScreen> {
  ...
  Future<void> _toggleDeviceActive(
    ...
    if (deviceId.isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Device ID is missing.')),
      );
      return;
    }

    final ok = await ref
        .read(adminDeviceListControllerProvider.notifier)
              ...
              children: ['All', 'Active', 'Maintenance', 'Inactive'].map((tab) {
                return SmallTab(
                  ...
                  onTap: () {
                    ...
                    updateLocalUiState(this, () => selectedTab = tab);
                    _loadDevices();
                  },
                );
              }).toList(),
  ...
  Widget _buildDeviceCardBody({
    ...
    final isUpdating = ref.watch(adminDeviceListControllerProvider.select((s) => s.updatingIds.contains(deviceId))); 
