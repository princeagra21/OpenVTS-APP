...
class AdminEditCompanyScreen extends ConsumerStatefulWidget {
  final AdminProfile profile;

  const AdminEditCompanyScreen({super.key, required this.profile});

  @override
  ConsumerState<AdminEditCompanyScreen> createState() => _AdminEditCompanyScreenState();
}

class _AdminEditCompanyScreenState extends ConsumerState<AdminEditCompanyScreen> {
    ...
    try {
      ...
      res.when(
        ...
        failure: (err) {
          ...
          _errorShown = true;
          final message =
              adminAccountIsKnownFailure(err) && adminAccountErrorMessage(err).trim().isNotEmpty
