...
class AdminUserActivityTab extends ConsumerStatefulWidget {
  final String userId;

  const AdminUserActivityTab({super.key, required this.userId});

  @override
  ConsumerState<AdminUserActivityTab> createState() => _AdminUserActivityTabState();
}

class _AdminUserActivityTabState extends ConsumerState<AdminUserActivityTab> {
