...
class GetAdminDriverUnlinkedUsersUseCase {
  const GetAdminDriverUnlinkedUsersUseCase(this._repository);
  final AdminDriverRepository _repository;
  Future<Result<List<AdminUserListItem>, AppError>> call(String driverId) => _repository.getUnlinkedUsers(driverId);
}
