class AdminDriverListItem {
  ...
  factory AdminDriverListItem.fromRaw(Map<String, Object?> raw) {
  ...
  String get driverVehicleLabel {
    ...
    if (nested is Map<String, Object?>) {
      final vehicleNode = nested['vehicle'] is Map
          ? Map<String, Object?>.from((nested['vehicle'] as Map).cast())
          : nested;
      ...
      final map = Map<String, Object?>.from(nested.cast());
      final vehicleNode = map['vehicle'] is Map
          ? Map<String, Object?>.from((map['vehicle'] as Map).cast())
          : map;
      final vehicleType = vehicleNode['vehicleType'];
      final typeName = vehicleType is Map
          ? _cleanText(
