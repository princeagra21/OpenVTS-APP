class AdminTransactionsSummary {
  ...
  factory AdminTransactionsSummary.fromRaw(Map<String, Object?> raw) {
  ...
  String get currency {
    ...
    if (totals is List && totals.isNotEmpty && totals.first is Map) {
      final map = Map<String, Object?>.from((totals.first as Map).cast());
  ...
  double? get amountFromTotalsByCurrency {
    ...
    for (final item in totals) {
      ...
      final map = Map<String, Object?>.from(item.cast());
