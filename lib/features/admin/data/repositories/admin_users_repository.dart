...
class AdminUsersRepository {
  ...
  AdminUsersRepository({required Object api}) : api = api is AdminTypedApiTransport ? api : AdminTypedApiTransport.fromDio((api as dynamic).dio as Dio);
  ...
  Future<Result<AdminUserDetails>> getUserDetails(
    ...
    final res = await api.get(
      AdminApiPaths.userDetails(userId),
      cancelToken: cancelToken,
    );
  ...
  Future<Result<String>> loginAsUser(
    ...
    final res = await api.get(
      AdminApiPaths.userLogin(userId),
      cancelToken: cancelToken,
    );
  ...
  Future<Result<List<AdminVehicleListItem>>> getUserLinkedVehicles(
    ...
    final res = await api.get(
      AdminApiPaths.linkVehicles(userId),
      cancelToken: cancelToken,
    );
    ...
    return res.when(
      ...
      failure: (err) async {
        ...
        final fallback = await api.get(
          AdminApiPaths.linkVehiclesBase,
  ...
  Future<Result<List<AdminVehicleListItem>>> getUnlinkedVehicles({
    ...
    final first = await parseResult(
      api.get(AdminApiPaths.unlinkVehicles, cancelToken: cancelToken),
    );
    ...
    if (userId != null && userId.trim().isNotEmpty) {
      final byPath = await parseResult(
        api.get(
          AdminApiPaths.unlinkVehiclesByUser(userId),
          cancelToken: cancelToken,
        ),
      );
  ...
  Future<Result<List<AdminDriverListItem>>> getUserLinkedDrivers(
    ...
    final res = await api.get(
      AdminApiPaths.userUnlinkedDrivers(userId),
      cancelToken: cancelToken,
    );
  ...
  Future<Result<List<AdminDocumentItem>>> getUserDocuments(
    ...
    final res = await api.get(
      AdminApiPaths.documents(userId),
      cancelToken: cancelToken,
    );
  ...
  Future<Result<void>> updateDocument({
    ...
    final res = await api.patch(
      AdminApiPaths.uploadDocById(documentId),
