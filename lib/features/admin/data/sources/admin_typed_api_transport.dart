...
part 'admin_typed_api_transport.g.dart';
...
@RestApi()
abstract class AdminTypedApiService {
...
class AdminTypedApiTransport {
  AdminTypedApiTransport({required AdminTypedApiService api}) : _api = api;

  factory AdminTypedApiTransport.fromDio(Dio dio) {
    return AdminTypedApiTransport(api: AdminTypedApiService(dio));
  }

  final AdminTypedApiService _api;
