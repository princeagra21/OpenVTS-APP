...
class _AdminDriverApiService implements AdminDriverApiService {
  _AdminDriverApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<ApiResponse<Map<String, dynamic>>> getDriverDetail(
    String driverId,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  Future<ApiResponse<void>> updateDriver(
    String driverId,
    AdminDriverUpdateRequestDto body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<List<Map<String, dynamic>>>> getDriverDocuments(
    String driverId,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<List<Map<String, dynamic>>>> getLinkedUsers(
    String driverId, {
    int? rk,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'rk': rk};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<List<Map<String, dynamic>>>>(
  ...
  @override
  Future<ApiResponse<List<Map<String, dynamic>>>> getUnlinkedUsers(
    String driverId, {
    int? rk,
  }) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<void>> assignUserToDriver(
    String driverId,
    AdminDriverUserLinkRequestDto body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<void>> unassignUserFromDriver(
    String driverId,
    AdminDriverUserLinkRequestDto body,
  ) async {
    final _extra = <String, dynamic>{};
