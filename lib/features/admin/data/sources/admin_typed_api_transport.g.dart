...
part of 'admin_typed_api_transport.dart';
...
class _AdminTypedApiService implements AdminTypedApiService {
  _AdminTypedApiService(this._dio, {this.baseUrl, this.errorLogger});
