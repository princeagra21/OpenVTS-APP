...
class _AdminVehicleApiService implements AdminVehicleApiService {
  _AdminVehicleApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<ApiResponse<List<Map<String, dynamic>>>> getVehicleDocuments(
    String vehicleId,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    final _options = _setStreamType<ApiResponse<List<Map<String, dynamic>>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/documents/vehicle/${vehicleId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<ApiResponse<Map<String, dynamic>>> getVehicleConfig(
    String vehicleId,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<void>> updateVehicleConfig(
    String vehicleId,
    AdminVehicleConfigUpdateRequestDto body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<ApiResponse<void>> updateVehicle(
    String vehicleId,
    UpdateAdminVehicleStatusRequestDto body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<ApiResponse<void>> assignDriver(
    String vehicleId,
    AdminVehicleDriverAssignmentRequestDto body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<ApiResponse<void>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/vehicles/${vehicleId}/driver',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
