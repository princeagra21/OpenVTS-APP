...
class _SupportScreenState extends State<SupportScreen> {
  ...
  Ticket _mapTicketItem(TicketListItem t) {
    ...
    final fromUserName = rawFromUser is Map
        ? rawFromUser['name']?.toString()
        : null;
    ...
    final title = normalizedTitle.isNotEmpty && normalizedTitle != '_'
        ? normalizedTitle
        : (t.ticketNumber.isNotEmpty ? t.ticketNumber : 'Support Ticket');
                  ...
                  children: [
                    Icon(
                      _normalizeTicketStatus(ticket.status) == 'Closed'
                          ...
                          : _normalizeTicketStatus(ticket.status) ==
                                'In Process'
