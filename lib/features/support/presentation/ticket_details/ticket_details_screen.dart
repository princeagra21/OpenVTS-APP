...
import 'package:open_vts/features/support/presentation/ticket_details/widgets/ticket_details_composer.dart';
import 'package:open_vts/features/support/presentation/ticket_details/widgets/ticket_details_header.dart';
import 'package:open_vts/features/support/presentation/ticket_details/widgets/ticket_details_messages.dart';
import 'package:open_vts/features/support/presentation/ticket_details/widgets/ticket_details_status_updater.dart';
import 'package:open_vts/features/support/presentation/ticket_details/widgets/ticket_details_tabs.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TicketDetailsStatusUpdater(
                        ...
                        onStatusChanged: (value) => updateLocalUiState(this, () => _state.selectedStatus = value),
                      ),
                      const SizedBox(height: 14),
                      TicketDetailsTabs(
                        config: _controller.config,
                        state: _state,
                        onTabChanged: (tab) => updateLocalUiState(this, () => _state.selectedComposerTab = tab),
                      ),
