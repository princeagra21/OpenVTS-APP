...
class _UserVehicleAddDocumentScreenState
  ...
  Future<void> _pickFile() async {
    ...
    updateLocalUiState(this, () => _selectedFile = file);
  }
                              ...
                              itemBuilder: (_, index) {
                                ...
                                return ListTile(
                                  ...
                                  trailing: selected
                                      ...
                                      : null,
                                  onTap: () {
                                    updateLocalUiState(this, () => _selectedDocType = item);
  ...
  Future<void> _upload() async {
    ...
    updateLocalUiState(this, () => _uploading = true);
    ...
    if (!mounted) return;
    updateLocalUiState(this, () => _uploading = false);
    if (error == null) {
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Switch.adaptive(
                            value: _isVisible,
                            onChanged: (value) =>
                                updateLocalUiState(this, () => _isVisible = value),
                          ),
                        ],
                      ),
                      const SizedBox(height: 24),
