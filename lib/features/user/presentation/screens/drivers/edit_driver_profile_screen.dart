...
class _EditDriverProfileScreenState extends ConsumerState<EditDriverProfileScreen> {
  late final _repo = ref.read(userDriversRepositoryAdapterProvider);
  ...
  Future<void> _loadDetails() async {
    ...
    final result = await _repo.getDriverDetails(
      widget.driverId,
      cancelToken: token,
    );
  ...
  Future<void> _save() async {
    ...
    final result = await _repo.updateDriver(
      widget.driverId,
      payload,
    );
          ...
          return Padding(
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  onPressed: () {
                    updateLocalUiState(this, () => _attributes.removeAt(index));
                  },
