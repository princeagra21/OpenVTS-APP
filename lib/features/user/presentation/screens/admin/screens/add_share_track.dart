...
class ShareTrackAddScreen extends ConsumerStatefulWidget {
  const ShareTrackAddScreen({super.key});

  @override
  ConsumerState<ShareTrackAddScreen> createState() => _ShareTrackAddScreenState();
}

class _ShareTrackAddScreenState extends ConsumerState<ShareTrackAddScreen> {
  ...
  late final _repo = ref.read(userShareTrackLinksRepositoryAdapterProvider);
  ...
  Future<void> _loadVehicles() async {
    ...
    if (!mounted) return;
    updateLocalUiState(this, () => _loadingVehicles = true);

    final result = await _repo.getVehicles(cancelToken: token);
  ...
  Future<void> _createLink() async {
    ...
    final result = await _repo.createLink(
                      ...
                      children: [
                        if (_loadingVehicles)
                          ...
                          CustomMultiDropdownField<VehicleListItem>(
                            ...
                            onChanged: (v) =>
                                updateLocalUiState(this, () => selectedVehicles = v),
                            fontSize: fs,
                        ...
                        SwitchListTile(
                          ...
                          value: geofence,
                          onChanged: (v) => updateLocalUiState(this, () => geofence = v),
                        ),
                        SwitchListTile(
                          title: Text(
                          ...
                          value: history24h,
                          onChanged: (v) => updateLocalUiState(this, () => history24h = v),
                        ),
                        const SizedBox(height: 24),
                        Text(
