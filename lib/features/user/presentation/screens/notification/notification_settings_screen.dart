...
import 'package:open_vts/features/user/presentation/controllers/user_notification_settings_controller.dart';
...
class _NotificationSettingsScreenState
  ...
  void initState() {
    super.initState();
    ref.read(userNotificationSettingsControllerProvider.notifier).load();
  }
  ...
  Widget build(BuildContext context) {
    final settingsState = ref.watch(userNotificationSettingsControllerProvider);
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              else if (settingsState.items.isEmpty)
