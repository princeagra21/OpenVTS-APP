...
part 'user_typed_api_transport.g.dart';
...
@RestApi()
abstract class UserTypedApiService {
  factory UserTypedApiService(Dio dio, {String? baseUrl}) = _UserTypedApiService;
...
class UserTypedApiTransport {
  UserTypedApiTransport({required UserTypedApiService api}) : _api = api;

  factory UserTypedApiTransport.fromDio(Dio dio) {
    return UserTypedApiTransport(api: UserTypedApiService(dio));
  }

  final UserTypedApiService _api;
