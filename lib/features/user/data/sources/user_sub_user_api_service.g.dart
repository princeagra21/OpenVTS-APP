...
class _UserSubUserApiService implements UserSubUserApiService {
  _UserSubUserApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<ApiResponse<List<Map<String, dynamic>>>> getSubUsers({
    int? page,
    int? limit,
  }) async {
  ...
  @override
  Future<ApiResponse<Map<String, dynamic>>> createSubUser(
    UserSubUserMutationDto body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<Map<String, dynamic>>> updateSubUser(
    String id,
    UserSubUserMutationDto body,
  ) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<List<Map<String, dynamic>>>> getSubUserVehicles(
    String id,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<void>> assignVehicle(
    String id,
    UserSubUserMutationDto body,
  ) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<void>> unassignVehicle(
    String id,
    UserSubUserMutationDto body,
  ) async {
    final _extra = <String, dynamic>{};
