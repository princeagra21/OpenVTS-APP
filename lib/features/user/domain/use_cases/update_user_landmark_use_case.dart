...
class UpdateUserLandmarkUseCase {
  const UpdateUserLandmarkUseCase(this._repository);
  final UserLandmarkRepository _repository;

  Future<Result<UserLandmarkItem, AppError>> call(UpdateUserLandmarkInput input) {
    return _repository.updateLandmark(input);
  }
}
