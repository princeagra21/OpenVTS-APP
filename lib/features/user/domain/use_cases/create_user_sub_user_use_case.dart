...
class CreateUserSubUserUseCase {
  const CreateUserSubUserUseCase(this._repository);
  final UserSubUserRepository _repository;
  Future<Result<UserSubUserItem, AppError>> call(Map<String, Object?> payload) => _repository.createSubUser(payload);
}
