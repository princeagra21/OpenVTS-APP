...
class AppUtils {
  ...
  static const Color errorColor =
      Colors.red; // Kept for errors; can be adjusted if needed
  ...
  static const EdgeInsets paddingHorizontalApp = EdgeInsets.symmetric(
    horizontal: 20.0,
  );
  ...
  static const double appBarHeightLarge =
      72.0; // For tablets or prominent headers
  ...
  static ThemeData getLightTheme() {
    ...
    return ThemeData(
      ...
      ).copyWith(secondary: black, surface: backgroundColor, error: errorColor),
    );
  }

  static ThemeData getDarkTheme() {
    const Color textColor = white;
    const Color subtleTextColor = Color(
      0xFFBDBDBD,
    ); // Lighter gray for subtlety in dark
    ...
    return ThemeData(
      ...
      colorScheme: ColorScheme.fromSwatch(
        ...
        brightness: Brightness.dark,
      ).copyWith(secondary: white, surface: backgroundColor, error: errorColor),
    );
  }
}
